...
impl RankSelect256 {
    ...
    fn select1_linear_search(&self, start: usize, end: usize, target_rank: usize) -> Result<usize> {
        ...
        Err(ToplingError::invalid_data("Select position not found".to_string()))
    }
    ...
    pub fn select0(&self, k: usize) -> Result<usize> {
        ...
        Err(ToplingError::invalid_data("Select0 position not found".to_string()))
    }
...
mod tests {
    ...
    fn test_space_efficiency() {
        ...
        println!("RankSelect256 overhead: {:.2}%", rs256.space_overhead_percent());
        println!("RankSelectSe256 overhead: {:.2}%", rs_se.space_overhead_percent());
    ...
    fn test_rank_consistency() {
        ...
        for pos in 0..=bv.len() {
            assert_eq!(rs256.rank1(pos), rs_se.rank1(pos), "Rank1 mismatch at pos {}", pos);
            assert_eq!(rs256.rank0(pos), rs_se.rank0(pos), "Rank0 mismatch at pos {}", pos);
        }
    }
