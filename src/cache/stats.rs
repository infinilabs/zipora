...
impl CacheStatsSnapshot {
    ...
    pub fn to_metrics(&self) -> std::collections::HashMap<String, f64> {
        ...
        metrics.insert(
            "average_probe_distance".to_string(),
            self.average_probe_distance,
        );
        metrics.insert(
            "average_read_time_ns".to_string(),
            self.average_read_time_ns,
        );
        metrics.insert(
